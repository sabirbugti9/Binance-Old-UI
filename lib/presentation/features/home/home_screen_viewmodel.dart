...
import 'package:binanceui/services/api.dart';
...
class HomeScreenViewModel with ChangeNotifier {
  ...
  Future<List<String>> fetchSymbols() async {
    try {
      symbolModelList = await Api().fetchSymbols();
  ...
  Future<void> fetchCandles({String? newSymbol, String? newTimeOption}) async {
    ...
    final fetchedCandles = await Api().fetchCandles(
  ...
  Future<void> loadMoreCandles() async {
    ...
    try {
      final data = await Api().fetchCandles(
